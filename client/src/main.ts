...
/*
 * This file is the game and nothing else now.
 *
 * It used to check the path first and draw /official, /rules or /roadmap
 * instead of booting - the pages were in this bundle, so a reader of the rules
 * downloaded Phaser to see them. They live in the site bundle now, which is a
 * twentieth of the size, and the server sends play.html only for /play. So
 * there is no longer a path this file can be running on that does not want a
 * game.
 */
