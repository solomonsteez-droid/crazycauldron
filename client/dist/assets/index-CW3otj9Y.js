import{e as ue,C as s,R,I as z,S as M,a as ge,i as V,w as se,t as Oe,J as Ee,B as Ae,N as le}from"./motionMath-DKo0Q_Za.js";class fe{constructor(t){this.markup=t}}const Le={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"};function Me(e){return String(e).replace(/[&<>"']/g,t=>Le[t]??t)}function be(e){return e instanceof fe?e.markup:Array.isArray(e)?e.map(be).join(""):e==null||e===!1?"":Me(e)}function r(e,...t){let a=e[0]??"";for(let n=0;n<t.length;n+=1)a+=be(t[n])+(e[n+1]??"");return new fe(a)}function de(e,t){e.innerHTML=t.markup}function _e(e,t){if(document.getElementById(e))return;const a=document.createElement("style");a.id=e,a.textContent=t,document.head.append(a)}function E(e){return e===null?"—":e.toLocaleString("en-US")}const Pe=`
:root {
  --night: #14101a;
  --shadow: #0c0912;
  --panel: #1d1728;
...
`,X={domain:"crazycauldron.art",cookMint:"",showMint:!1,treasuryWallet:"",minHold:2e3,social:{x:"none",telegram:"none"},shopEnabled:!1};async function ye(e,t=6e3){const a=new AbortController,n=setTimeout(()=>a.abort(),t);try{const o=await fetch(`${ue.httpUrl}${e}`,{signal:a.signal});return o.ok?await o.json():null}catch{return null}finally{clearTimeout(n)}}async function Ie(){const e=await ye("/public/config");return e?{...X,...e,social:{...X.social,...e.social??{}}}:X}async function Fe(){return ye("/stats",4e3)}function D(e){const t=e.trim();return t===""||t.toLowerCase()==="none"?null:t}function ze(e,t=6){return e.length<=t*2+3?e:`${e.slice(0,t)}…${e.slice(-t)}`}const Ne=[{id:"how-it-works",label:"how it works"},{id:"the-world",label:"the world"},{id:"skills",label:"skills"},{id:"cooking",label:"cooking"},{id:"wardrobe",label:"wardrobe"},{id:"roadmap",label:"roadmap"},{id:"token",label:"$COOK"},{id:"proof",label:"proof"}];function we(e){const t=e?"":"/";return r`
    <header class="topbar">
      <div class="inner">
  ...
  `}function Re(e){const t=[r`<span><b data-live="playersOnline">${E((e==null?void 0:e.playersOnline)??null)}</b> players online</span>`,r`<span><b data-live="chefsRegistered">${E((e==null?void 0:e.chefsRegistered)??null)}</b> chefs registered</span>`,r`<span><b data-live="dishesCooked">${E((e==null?void 0:e.dishesCooked)??null)}</b> dishes cooked</span>`,r`<span><b data-live="superbsToday">${E((e==null?void 0:e.superbsToday)??null)}</b> superbs today</span>`,r`<span>creator fees fund servers and development</span>`,r`<span>nothing is paid out to holders</span>`,r`<span>not financial advice</span>`];return r`
    <div class="ticker" aria-hidden="true">
      <div class="ticker-track" id="ticker-track">${t}${t}</div>
    </div>
  `}function ve(e){const t=D(e.social.x),a=D(e.social.telegram);return r`
  ...
  `}function A(e){const t=e.painting?r`<img
        class="band-art"
  ...
  `}function Ke(){if(window.matchMedia("(prefers-reduced-motion: reduce)").matches)return;const e=Array.from(document.querySelectorAll(".band-art"));if(e.length===0)return;let t=!1;const a=()=>{t=!1;const o=window.innerHeight/2;for(const l of e){const c=l.parentElement;if(!c)continue;const d=c.getBoundingClientRect();if(d.bottom<-200||d.top>window.innerHeight+200)continue;const h=d.top+d.height/2,y=Math.max(-60,Math.min(60,(h-o)/o*-48));l.style.transform=`translate3d(0, ${y.toFixed(1)}px, 0)`}},n=()=>{t||(t=!0,requestAnimationFrame(a))};window.addEventListener("scroll",n,{passive:!0}),window.addEventListener("resize",n,{passive:!0}),a()}function He(e){for(const t of Array.from(e.querySelectorAll("[data-copy]")))t.addEventListener("click",()=>{var o;const a=t.dataset.copy??"",n=t.textContent??"Copy";(o=navigator.clipboard)==null||o.writeText(a).then(()=>{t.textContent="Copied",setTimeout(()=>t.textContent=n,1600)}).catch(()=>{t.textContent="Press ⌘C",setTimeout(()=>t.textContent=n,2200)})})}const We=s.skills.maxLevel;function qe(e,t){const a=t[e],n=new Set(s.unlocks[e].map(l=>l.level));let o=0;for(let l=2;l<=a;l+=1)n.has(l)||(o+=s.skills.coreStat[e].perLevelPct);return o}function ke(e,t){const{windowPctAtLevel1:a,windowPctAtLevel20:n}=s.cooking,o=We-1,l=Math.min(Math.max(e.firecraft-1,0),o)/o,c=a+(n-a)*l,d=s.economy.pan.find(m=>m.tier===t),h=c+((d==null?void 0:d.windowBonusPct)??0),y=1+qe("knifework",e)/100;return Math.min(h*y,100)}const Z=45,ee=90;function $e(e,t){const a=Math.min(Math.max(e,0),Z),n=Math.min(Math.max(e*s.cooking.fineWindowMultiplier,a),ee),o=a/200,l=n/200,c=d=>Math.min(Math.max(d,0),1);return{centre:t,superbPct:a,finePct:n,superbFrom:c(t-o),superbTo:c(t+o),fineFrom:c(t-l),fineTo:c(t+l)}}const Be=[{id:"bronze",minHold:5e3},{id:"silver",minHold:2e4},{id:"gold",minHold:1e5}],je=[{id:"hat_01_chef",kind:"hat",name:"Chef toque",unlock:{type:"cookQuality",minQuality:"fine"}},{id:"hat_02_straw",kind:"hat",name:"Straw hat",unlock:{type:"skillLevel",skill:"foraging",level:10}},{id:"hat_03_mushroom",kind:"hat",name:"Mushroom cap",unlock:{type:"dishesCooked",count:50}},{id:"hat_04_acorn",kind:"hat",name:"Acorn cap",unlock:{type:"sectionRecipes",section:2}},{id:"hat_05_circlet",kind:"hat",name:"Circlet",unlock:{type:"anySkillLevel",level:20}},{id:"hat_06_dragonscale",kind:"hat",name:"Dragonscale hat",unlock:{type:"recipeQuality",recipeNumber:20,quality:"superb"}},{id:"hat_07_moonpetal",kind:"hat",name:"Moonpetal crown",unlock:{type:"recipeQuality",recipeNumber:19,quality:"superb"}},{id:"hat_08_bronze",kind:"hat",name:"Bronze toque",unlock:{type:"tier",tier:"bronze"}},{id:"hat_09_gold",kind:"hat",name:"Gold toque",unlock:{type:"tier",tier:"gold"}},{id:"companion_01_hen",kind:"companion",name:"Hen",unlock:{type:"start"}},{id:"companion_02_piglet",kind:"companion",name:"Piglet",unlock:{type:"chefLevel",level:5}},{id:"companion_03_berrymouse",kind:"companion",name:"Berrymouse",unlock:{type:"chefLevel",level:10}},{id:"companion_04_mole",kind:"companion",name:"Mole",unlock:{type:"skillLevel",skill:"prospecting",level:10}},{id:"companion_05_owlet",kind:"companion",name:"Owlet",unlock:{type:"chefLevel",level:20}},{id:"companion_06_glowslime",kind:"companion",name:"Glowslime",unlock:{type:"tier",tier:"silver"}},{id:"companion_07_emberfox",kind:"companion",name:"Emberfox",unlock:{type:"tier",tier:"gold"}}],De={tiers:Be,items:je},xe=De,N=xe.items,te=xe.tiers;function Ge(e){var t;return((t=te.find(a=>a.id===e))==null?void 0:t.minHold)??0}function Ce(e){switch(e.type){case"start":return"Yours from the start";case"chefLevel":return`Reach Chef Level ${e.level}`;case"skillLevel":return`Reach ${e.skill} ${e.level}`;case"anySkillLevel":return`Take any skill to ${e.level}`;case"dishesCooked":return`Cook ${e.count} dishes`;case"cookQuality":return`Cook any dish at ${e.minQuality} or better`;case"sectionRecipes":return"Cook every Deep Forest recipe at least once";case"recipeQuality":{const t=R[e.recipeNumber-1];return`Cook ${(t==null?void 0:t.name)??`recipe ${e.recipeNumber}`} at ${e.quality}`}case"tier":return`Hold ${Ge(e.tier).toLocaleString()} $COOK`;default:return"Locked"}}const T="/assets/generated",w={painting(e,t=!1){return`/assets/site/${e}-${t?"narrow":"wide"}.jpg`},paintingSrcset(e){return`${w.painting(e,!0)} 720w, ${w.painting(e,!1)} 1440w`},hat:e=>`${T}/hats/${e}.png`,companion:e=>`${T}/companions/${e}.png`,dish:e=>`${T}/dishes/${e}.png`,ingredient:e=>`${T}/ingredients/${e}.png`,prop:e=>`${T}/props/${e}.png`,node:e=>`${T}/nodes/${e}.png`,character:e=>`${T}/characters/${e}.png`,async hatOffsets(){try{const e=await fetch(`${T}/offsets.json`);if(!e.ok)return{};const t=await e.json(),a={};for(const[n,o]of Object.entries(t.hats??{}))o.down&&(a[n]=o.down);return a}catch{return{}}}};function Xe(e){return new Promise(t=>{const a=new Image;a.decoding="async",a.onload=()=>t(a),a.onerror=()=>t(null),a.src=e})}async function ce(e){var h,y,m,f;const[t,a,n]=await Promise.all([Xe(w.character(e)),fetch(`${T}/characters/${e}.json`).then(u=>u.ok?u.json():null).catch(()=>null),fetch(`${T}/manifest.json`).then(u=>u.ok?u.json():null).catch(()=>null)]);if(!t||!a)return null;const o=new Map(a.frames.map(u=>[u.filename,u.frame])),c=(((f=(m=(y=(h=n==null?void 0:n.bodies)==null?void 0:h[e])==null?void 0:y.walk)==null?void 0:m.right)==null?void 0:f.order)??[0,1,2,3]).map(u=>o.get(`${e}_walk_right_${u}`)).filter(u=>u!==void 0),d=c[0]??o.get(`${e}_idle_down`);return!d||c.length===0?null:{sheet:t,walkRight:c,frameWidth:d.w,frameHeight:d.h}}const Ue={1:"map_meadows",2:"map_forest",3:"map_caves"};function Qe(e){const t=z.filter(a=>a.section===e);return r`
  ...
  `}function Ve(e){const t=[{title:`Hold ${e.minHold.toLocaleString()} $COOK`,body:`The door opens at ${e.minHold.toLocaleString()} $COOK in your wallet. It is checked when you sign in and every half hour while you play, and nothing is ever taken from your wallet to enter.`},{title:"Connect Phantom and sign in",body:"One signature, which is free and is not a transaction: it proves the wallet is yours and does nothing else. No approvals, no spend permissions, no gas."},{title:"Gather, cook, sell, level up",body:"Forage the meadows, time the heat bar, sell what you cook to the Tavern, and put the coins into a better pan so the next dish is easier."}],a=[{title:"Expedition",art:w.node("node_berry"),body:"Pick a biome and fill the bag."},{title:"Kitchen",art:w.prop("kitchen"),body:"Prep, then time the heat."},{title:"Tavern",art:w.prop("tavern"),body:"Sell the dish. Eat one yourself."},{title:"Deeper",art:w.prop("portal_forest"),body:"Chef Levels open the next biome."}];return A({id:"how-it-works",painting:"map_hub",label:"how-it-works.txt",eager:!0,body:r`
    ...
    `})}function Ze(){return A({id:"the-world",painting:"map_meadows",label:"the-world.txt",body:r`
  ...
  `}function G(e){return $e(ke({foraging:1,prospecting:1,knifework:1,firecraft:e,spicecraft:1},0),.5)}function ot(){const e=G(1),t=G(s.skills.maxLevel);return A({id:"skills",painting:"map_forest",label:"skills.txt",body:r`
      ...
      <div class="grid cols-3">${ge.map(nt)}</div>
      ...
      <div class="card card-warm" style="margin-top: 1.4rem">
        ...
        <p class="small">
          ...
          behind it, and capped at ${Z}% so there is always a bar
  ...
  `}function it(){const e=document.getElementById("heat-track"),t=document.getElementById("heat-fine"),a=document.getElementById("heat-superb"),n=document.getElementById("heat-marker"),o=document.getElementById("heat-result"),l=document.getElementById("heat-demo");if(!e||!t||!a||!n||!o||!l)return;let c=1,d=G(c),h=!0,y=!0,m=0;const f=()=>{t.style.left=`${d.fineFrom*100}%`,t.style.width=`${(d.fineTo-d.fineFrom)*100}%`,a.style.left=`${d.superbFrom*100}%`,a.style.width=`${(d.superbTo-d.superbFrom)*100}%`},u=()=>m>=d.superbFrom&&m<=d.superbTo?"Superb":m>=d.fineFrom&&m<=d.fineTo?"Fine":"Common";for(const C of Array.from(l.querySelectorAll("[data-firecraft]")))C.addEventListener("click",()=>{c=Number(C.dataset.firecraft??"1"),d=G(c);for(const O of Array.from(l.querySelectorAll("[data-firecraft]")))O.setAttribute("aria-pressed",String(O===C));h=!0,o.textContent=`Superb is ${d.superbPct.toFixed(1)}% of the bar here.`,f()});const v=l.querySelector("[data-heat-stop]"),L=()=>{h=!h,o.textContent=h?"A demo. Nothing here is scored or saved.":`${u()}. A demo — nothing here is scored or saved.`,v==null||v.setAttribute("aria-pressed",String(!h))};v==null||v.addEventListener("click",L),e.addEventListener("click",L);const F=s.cooking.barMs/s.cooking.markerSpeedMultiplier;let K=performance.now(),H=0;const W=C=>{const O=Math.min(64,C-K);if(K=C,h&&y){H+=O;const _=H%(F*2)/F;m=_<=1?_:2-_,n.style.left=`${m*100}%`}requestAnimationFrame(W)};"IntersectionObserver"in window&&new IntersectionObserver(C=>{for(const O of C)y=O.isIntersecting},{rootMargin:"120px"}).observe(e),f(),requestAnimationFrame(W)}function st(e){var t;return((t=M.find(a=>a.index===e))==null?void 0:t.name)??""}const lt={raw:"Raw",pan_fry:"Pan-fry",simmer:"Simmer",bake:"Bake",clay_bake:"Clay bake",roast:"Roast",smoke:"Smoke",chill:"Chill"};function dt(e){const t=Object.entries(e.requirements).map(([a,n])=>`${s.skills.names[a]} ${n}`);return t.length===0?"No requirements":t.join(" · ")}function ct(e){return r`
    <article class="card recipe" data-biome="${e.section}">
      ...
      <div>
        ...
        <p class="small" style="margin: 0.3rem 0 0">
          ${e.ingredients.map(t=>`${t.qty}× ${V(t.id).name}`).join(", ")}
        </p>
        <p class="meta">${dt(e)}</p>
      </div>
    </article>
  `}function ht(){const e=s.cooking.quality;return A({id:"cooking",painting:"map_caves",label:"cooking.txt",body:r`
      ...
      <h3 style="margin-top: 1.8rem">All ${R.length} recipes</h3>
  ...
  `}function ut(){const e=N.filter(a=>a.kind==="hat"),t=N.filter(a=>a.kind==="companion");return A({id:"wardrobe",painting:null,label:"wardrobe.txt",body:r`
  ...
  `}function ft(e){const t=e.showMint&&e.cookMint.trim()!=="";return A({id:"token",painting:"map_hub",label:"token.txt",body:r`
  ...
  `}function Tt(){return A({id:"roadmap",painting:"map_forest",label:"roadmap.txt",body:Te()})}function St(e,t){return r`
    <section class="hero">
      ...
      <div class="inner">
        ...
        <p class="live" id="live-line">
          ...
          <span><b data-live="playersOnline">${E((t==null?void 0:t.playersOnline)??null)}</b> playing now</span>
          <span><b data-live="chefsRegistered">${E((t==null?void 0:t.chefsRegistered)??null)}</b> chefs registered</span>
          <span><b data-live="dishesCooked">${E((t==null?void 0:t.dishesCooked)??null)}</b> dishes cooked</span>
        </p>
  ...
  `}function Ot(e){return r`
    ${Ve(e)} ${Ze()} ${ot()} ${ht()}
    ${ut()} ${Tt()} ${ft(e)} ${bt(e)}
  `}function Et(e,t){return r`
    ${we(!0)}
    <main class="site-wrap">${St(e,t)} ${Ot(e)}</main>
    ${Re(t)} ${ve(e)}
  `}function At(e){for(const t of Array.from(document.querySelectorAll("[data-live]"))){const a=t.dataset.live;a&&typeof e[a]=="number"&&(t.textContent=E(e[a]))}}const U=8e3,S=3;function Q(e){return new Promise(t=>{const a=new Image;a.decoding="async",a.onload=()=>t(a),a.onerror=()=>t(null),a.src=e})}function Lt(e){const t=e.getContext("2d",{alpha:!0});if(!t)return()=>{};const a=window.matchMedia("(prefers-reduced-motion: reduce)").matches;let n=0,o=0,l=null,c=[];const d=[];let h=null,y=performance.now()+4e3;const m=[];let f=0,u=!1;function v(){const p=e.getBoundingClientRect(),i=Math.min(window.devicePixelRatio||1,2);n=Math.max(1,Math.round(p.width)),o=Math.max(1,Math.round(p.height)),e.width=Math.round(n*i),e.height=Math.round(o*i),t.setTransform(i,0,0,i,0,0),t.imageSmoothingEnabled=!1,L(),F()}function L(){const p=a?0:Math.min(46,Math.round(n/26));c=Array.from({length:p},(i,g)=>{const b=(g+.5)/p*n+(Math.sin(g*12.9898)*.5+.5)*14,$=Math.sin(g*78.233)*.5+.5;return{x:b,y:o-6-$*Math.min(70,o*.1),height:7+$*9,phase:g*.7,shade:$>.5?"rgba(92, 138, 74, 0.55)":"rgba(63, 107, 70, 0.5)"}})}function F(){const p=o-Math.min(48,o*.07);for(let i=0;i<m.length;i+=1)m[i].y=p-i*6}function K(p){if(!l){t.fillStyle="#14101a",t.fillRect(0,0,n,o);return}const i=Math.max(n/l.width,o/l.height),g=l.width*i,b=l.height*i,$=a?0:se(p,0,U*3,n)*9;t.drawImage(l,(n-g)/2+$,(o-b)*.62,g,b)}function H(p){for(const i of c){const g=Oe(p,i.x,i.phase,U,n);t.save(),t.translate(i.x,i.y),t.rotate(g.angle*Math.PI/180),t.fillStyle=i.shade,t.fillRect(-1,-i.height,2,i.height),t.fillRect(-3,-i.height*.6,2,i.height*.6),t.fillRect(1,-i.height*.75,2,i.height*.75),t.restore()}}function W(p,i){if(!a){if(f%22===0)for(const g of[.26,.68])d.push({x:n*g,y:o*.34,age:0,life:5200,drift:0,size:5});for(let g=d.length-1;g>=0;g-=1){const b=d[g];if(b.age+=i,b.age>b.life){d.splice(g,1);continue}const $=b.age/b.life;b.drift+=se(p,b.x,U,n)*.35,t.globalAlpha=(1-$)*.22,t.fillStyle="#cfc6bb",t.beginPath(),t.arc(b.x+b.drift,b.y-$*o*.22,b.size+$*16,0,Math.PI*2),t.fill(),t.globalAlpha=1}}}function C(p,i){if(a||(!h&&p>y&&(h={x:-30,y:o*(.18+Math.random()*.14),speed:.045+Math.random()*.02,phase:Math.random()*Math.PI*2}),!h))return;if(h.x+=h.speed*i,h.x>n+30){h=null,y=p+9e3+Math.random()*9e3;return}const g=Math.sin(p/90+h.phase)*4;t.strokeStyle="rgba(24, 20, 30, 0.55)",t.lineWidth=2,t.beginPath(),t.moveTo(h.x-6,h.y+g),t.lineTo(h.x,h.y),t.lineTo(h.x+6,h.y+g),t.stroke()}function O(p){for(const i of m){i.x+=i.speed*p,i.x>n+60&&(i.x=-60-Math.random()*120),i.step+=p;const g=i.body.walkRight,b=g[Math.floor(i.step/100)%g.length],$=b.w*S,q=b.h*S,B=Math.round(i.x),k=Math.round(i.y-q),P=Math.floor(i.step/200)%2===0?0:S;if(t.drawImage(i.body.sheet,b.x,b.y,b.w,b.h,B,k+P,$,q),i.hat&&t.drawImage(i.hat,B+i.hatOffset.x*S,k+P+i.hatOffset.y*S,i.hat.width*S,i.hat.height*S),i.companion){const re=i.companion.width*S,ie=i.companion.height*S;t.drawImage(i.companion,Math.round(i.x-re-8),Math.round(i.y-ie+P),re,ie)}}}let _=performance.now();function ne(p){if(u)return;const i=Math.min(64,p-_);_=p,f+=1,t.clearRect(0,0,n,o),K(p),W(p,i),C(p,i),H(p),O(i),requestAnimationFrame(ne)}const oe=()=>v();return window.addEventListener("resize",oe,{passive:!0}),v(),requestAnimationFrame(ne),(async()=>{const p=window.innerWidth<900;l=await Q(w.painting("map_hub",p));const i=await Promise.all([ce("male"),ce("female")]),g=["hat_01_chef","hat_05_circlet","hat_03_mushroom","hat_07_moonpetal"],b=["companion_01_hen","companion_07_emberfox","companion_02_piglet",null],[$,q,B]=await Promise.all([Promise.all(g.map(k=>Q(w.hat(k)))),Promise.all(b.map(k=>k?Q(w.companion(k)):Promise.resolve(null))),w.hatOffsets()]);for(let k=0;k<g.length;k+=1){const P=i[k%2];P&&m.push({x:-80-k*150,y:o,speed:.022+k*.004,body:P,hat:$[k]??null,hatOffset:B[g[k]??""]??{x:6,y:-12},companion:q[k]??null,step:k*340})}F()})(),()=>{u=!0,window.removeEventListener("resize",oe)}}const J=e=>Math.round(e/6e4);function Y(e,t=1,a=0){return $e(ke({foraging:1,prospecting:1,knifework:t,firecraft:e,spicecraft:1},a),.5)}const Mt={raw:"Raw",pan_fry:"Pan-fry",simmer:"Simmer",bake:"Bake",clay_bake:"Clay bake",roast:"Roast",smoke:"Smoke",chill:"Chill"};function me(e){var t;return((t=M.find(a=>a.index===e))==null?void 0:t.name)??""}function _t(e){return[{id:"what-it-is",title:"1. What CrazyCauldron is",body:()=>r`
        <p>
      ...
      `},{id:"getting-in",title:"2. Getting in",body:()=>r`
        ...
        <p>
          ...
          ${J(Ae)} minutes; the room re-checks every holder on
        ...
        <p>
          ...
          ${J(le)} minutes and is consumed on use, so a captured
      ...
      `},{id:"the-world",title:"3. The world",body:()=>r`
            ...
            <tbody>
              ${M.map(t=>r`
                  <tr>
                    ...
                    <td class="small">
                      ${z.filter(a=>a.section===t.index).length}
                    </td>
                  </tr>
                `)}
            </tbody>
        ...
        <h3>All ${z.length} ingredients</h3>
        <div class="table-scroll">
          <table>
            <thead>
              <tr>
            ...
            <tbody>
              ${z.map(t=>r`
                  <tr>
                    <td>${t.name}</td>
                    <td class="small">${me(t.section)}</td>
      ...
      `}},{id:"cooking",title:"6. Cooking",body:()=>{const t=Y(1),a=Y(s.skills.maxLevel),n=Y(s.skills.maxLevel,s.skills.maxLevel,2);return r`
          <h3>The heat bar</h3>
          <p>
            ...
            <table>
              ...
              <tbody>
                ${R.map(o=>r`
                    <tr>
                      <td>${o.name}</td>
                      <td class="small">${me(o.section)}</td>
                      <td class="small">
                        ${Mt[o.technique]??o.technique}
                      </td>
                      <td class="num">${o.chefXp}</td>
                      <td class="num">${o.sellCoins}</td>
                      <td class="small">
                        ${o.ingredients.map(l=>`${l.qty}× ${V(l.id).name}`).join(", ")}
                      </td>
                      <td class="small muted">
                        ${Object.entries(o.requirements).map(([l,c])=>`${s.skills.names[l]} ${c}`).join(", ")||"—"}
                      </td>
                    </tr>
                  `)}
              </tbody>
            ...
            <tbody>
              ${s.economy.pan.map(t=>r`
                  <tr>
                    ...
                    <td class="small muted">
                      ${t.items.map(a=>`${a.qty}× ${V(a.id).name}`).join(", ")||"—"}
                    </td>
                  </tr>
                `)}
            </tbody>
      ...
      `},{id:"cosmetics",title:"8. Cosmetics",body:()=>{const t=N.filter(n=>n.kind==="hat"),a=N.filter(n=>n.kind==="companion");return r`
          <p>
          ...
          <ul>
            ${te.map(n=>r`<li>${n.id}: ${n.minHold.toLocaleString()} $COOK</li>`)}
          </ul>
      ...
      `},{id:"fair-play",title:"10. Fair play and safety",body:()=>r`
        ...
        <p>
          ...
          ${J(le)} minutes and is consumed when used. A captured
      ...
      `},{id:"roadmap",title:"11. Roadmap",body:()=>Te()},{id:"risks",title:"12. Risks and disclaimer",body:()=>r`
        <div class="warn">
          <p>
            <strong>$COOK is a community token.</strong> It is not a share, not an
      ...
      `}]}function Pt(e){const t=_t(e);return r`
    ${we(!1)}
    ...
    ${ve(e)}
  `}function It(){var a;const e=new Map;for(const n of Array.from(document.querySelectorAll(".wp-toc a")))e.set(((a=n.getAttribute("href"))==null?void 0:a.slice(1))??"",n);if(e.size===0||!("IntersectionObserver"in window))return;const t=new IntersectionObserver(n=>{var o;for(const l of n)if(l.isIntersecting){for(const c of e.values())c.classList.remove("here");(o=e.get(l.target.id))==null||o.classList.add("here")}},{rootMargin:"-20% 0px -70% 0px"});for(const n of e.keys()){const o=document.getElementById(n);o&&t.observe(o)}}const Ft=["/official","/rules","/roadmap"];function Se(e){const t=e.replace(/\/+$/,"")||"/";return Ft.includes(t)?t:null}const pe={domain:"crazycauldron.art",cookMint:"",minHold:0,social:{x:"none",telegram:"none"}};async function zt(){try{const e=await fetch(`${ue.httpUrl}/public/config`);return e.ok?await e.json():pe}catch{return pe}}function Nt(){const e=document.createElement("style");e.textContent=`
    /*
  ...
  `,document.head.append(e)}function Rt(e){const t=document.createElement("nav");t.className="cc-nav";for(const[a,n]of[["/","← Play"],["/official","Official"],["/rules","Rules"],["/roadmap","Roadmap"]]){if(a===e)continue;const o=document.createElement("a");o.href=a,o.textContent=n,t.append(o)}return t}function ae(e,t){const a=document.createDocumentFragment(),n=document.createElement("h1");n.textContent=e;const o=document.createElement("p");return o.className="lead",o.textContent=t,a.append(n,o),a}function Kt(e){const t=document.createElement("div");t.className="cc-address";const a=document.createElement("code");if(a.textContent=e||"not published yet",t.append(a),e){const n=document.createElement("button");n.type="button",n.textContent="Copy",n.addEventListener("click",()=>{var o;(o=navigator.clipboard)==null||o.writeText(e).then(()=>{n.textContent="Copied",setTimeout(()=>n.textContent="Copy",1500)},()=>{n.textContent="Select it"})}),t.append(n)}return t}function x(e,t){const a=document.createElement("p");return a.textContent=e,t&&(a.className=t),a}function j(e){const t=document.createElement("ul");for(const a of e){const n=document.createElement("li");n.textContent=a,t.append(n)}return t}async function Ht(e){const t=await zt();document.title="CrazyCauldron - Official",e.append(ae("Official","Everything real about CrazyCauldron is on this page. If you found it anywhere else, check it here first."));const a=document.createElement("h2");a.textContent="The site";const n=document.createElement("p"),o=document.createElement("a");o.href=`https://${t.domain}`,o.textContent=t.domain,n.append("The game lives at ",o,". There is no other site."),e.append(a,n);const l=document.createElement("h2");l.textContent="The $COOK contract address",e.append(l,Kt(t.cookMint));const c=document.createElement("div");c.className="cc-warn",c.append(x("This is the only $COOK. Any other contract address is a different token, whatever it is called and whoever is posting it."),x("Copy the address from this page and paste it into your wallet yourself. Do not trust one sent to you, and do not connect your wallet to a site you did not reach from this domain.","cc-note")),e.append(c),t.minHold>0&&e.append(x(`Holding at least ${t.minHold.toLocaleString()} $COOK opens the hub. The balance is checked when you sign in and while you play; nothing is ever taken from your wallet to enter.`));const d=document.createElement("h2");d.textContent="Where the fees go",e.append(d,x("Trading $COOK generates standard pump.fun creator fees. Those fees are received by the team at the project treasury wallet."),x("Nothing is paid out to holders. Holding $COOK is not a claim on those fees or on any other payment, and there is no distribution, revenue share or payout attached to it."),x("The fees fund the servers and the development, and that is what they are for. Anything spent inside the game is separate again: half of a purchase is burned and half goes to the project treasury.","cc-note"));const h=document.createElement("h2");h.textContent="Where we post",e.append(h);const y=[];for(const[m,f]of[["X",t.social.x],["Telegram",t.social.telegram]])y.push(f&&f!=="none"?`${m}: ${f}`:`${m}: no account yet. Anything claiming to be our ${m} is not ours.`);e.append(j(y)),e.append(x("When an account does exist, it will be listed here first. This page is the source, not the announcement.","cc-note"))}function Wt(e){document.title="CrazyCauldron - Rules",e.append(ae("Rules","Short, and in plain language. Read the last section before you buy anything."));const t=document.createElement("h2");t.textContent="Playing",e.append(t,j(["Sign in with your wallet. Signing proves the wallet is yours; it never moves tokens and never asks for a key.","Holding enough $COOK opens the hub. Nothing is spent to enter, and your tokens stay in your wallet.","Everything you gather, cook and earn belongs to the wallet that earned it, and is there when you come back.","Play fairly. The server decides what happened - where you are, what you gathered, what you cooked - so a modified client gains nothing and a wallet that keeps trying will be shut out.","One person, as many wallets as you like. But progress does not transfer between them, and neither do cosmetics."]));const a=document.createElement("h2");a.textContent="Cosmetics",e.append(a,j(["Hats and cloaks are cosmetic. None of them changes how fast you gather, how well you cook, or what you earn.","Most are earned by playing. Some can also be bought with $COOK, and nothing is ever purchase-only.","A few are tied to your $COOK balance rather than owned. If the balance falls, the garment comes off and returns when it recovers.","Cosmetics belong to the wallet, not to you. They are not tradable and cannot be moved to another wallet."]));const n=document.createElement("h2");n.textContent="About $COOK";const o=document.createElement("div");o.className="cc-warn",o.append(x("$COOK is a community token. It is not a share, not an investment, and not a claim on anything we own or earn."),x("Trading $COOK generates standard pump.fun creator fees, which the team receives at the project treasury wallet and uses to run the servers and build the game. Nothing is paid out to holders."),x("We make no promise about its price, and no promise of rewards, income, airdrops or returns of any kind. Nothing on this site is financial advice."),x("There are no cash prizes. Nothing in the game pays out money, and coins earned by playing exist only inside the game."),x("Anything you spend is spent. A purchase burns half the tokens and sends half to the project treasury; neither half comes back, and there are no refunds."),x("Only buy what you can afford to lose. Token prices go down as easily as up, and this one can go to nothing.")),e.append(n,o);const l=document.createElement("h2");l.textContent="What we can change",e.append(l,j(["The game is under development. Numbers get tuned, features get added, and things occasionally break.","We may change prices, drop rates and unlock conditions. We will not take away a cosmetic you have earned.","The roadmap is a plan, not a promise. What gets built, and when, depends on how many people are playing."]))}function qt(e,t){const a=e.replace(/\r\n/g,`
`).split(`
`);let n=0;const o=c=>c.replace(/^\||\|$/g,"").split("|").map(d=>d.trim()),l=(c,d)=>{const h=/(\*\*[^*]+\*\*|`[^`]+`)/g;let y=0;for(const m of c.matchAll(h)){const f=m.index??0;f>y&&d.append(c.slice(y,f));const u=m[0];if(u.startsWith("`")){const v=document.createElement("code");v.textContent=u.slice(1,-1),d.append(v)}else{const v=document.createElement("strong");v.textContent=u.slice(2,-2),d.append(v)}y=f+u.length}y<c.length&&d.append(c.slice(y))};for(;n<a.length;){const c=a[n]??"";if(c.trim()===""){n+=1;continue}const d=/^(#{1,4})\s+(.*)$/.exec(c);if(d){const m=Math.min(d[1].length,4),f=document.createElement(`h${m}`);l(d[2],f),t.append(f),n+=1;continue}if(c.includes("|")&&(a[n+1]??"").includes("---")){const m=document.createElement("table"),f=document.createElement("tr");for(const u of o(c)){const v=document.createElement("th");l(u,v),f.append(v)}for(m.append(f),n+=2;n<a.length&&(a[n]??"").includes("|");){const u=document.createElement("tr");for(const v of o(a[n]??"")){const L=document.createElement("td");l(v,L),u.append(L)}m.append(u),n+=1}t.append(m);continue}if(/^[-*]\s+/.test(c)){const m=document.createElement("ul");for(;n<a.length&&/^[-*]\s+/.test(a[n]??"");){const f=document.createElement("li");l((a[n]??"").replace(/^[-*]\s+/,""),f),m.append(f),n+=1}t.append(m);continue}const h=[];for(;n<a.length&&(a[n]??"").trim()!=="";)h.push(a[n]??""),n+=1;const y=document.createElement("p");l(h.join(" "),y),t.append(y)}}async function Bt(e){document.title="CrazyCauldron - Roadmap";try{const t=await fetch("/roadmap.md");if(!t.ok)throw new Error(String(t.status));qt(await t.text(),e)}catch{e.append(ae("Roadmap","The roadmap could not be loaded just now. Please try again shortly."))}}async function jt(e){var n,o;Nt(),(n=document.getElementById("game"))==null||n.remove(),(o=document.getElementById("boot"))==null||o.remove();const t=document.createElement("main");t.className="cc-page",t.append(Rt(e));const a=document.getElementById("ui")??document.body;a.replaceChildren(t),a.setAttribute("style","position:static;display:block;pointer-events:auto"),e==="/official"?await Ht(t):e==="/rules"?Wt(t):await Bt(t)}function Dt(e){const t=e.replace(/\/+$/,"")||"/";return t==="/whitepaper"||t==="/docs"?"whitepaper":t==="/roadmap"?"roadmap":Se(t)?"legal":"home"}const I=document.getElementById("site");async function Gt(){if(!I)return;const e=Dt(window.location.pathname);if(e==="legal"){I.remove();const n=Se(window.location.pathname.replace(/\/+$/,"")||"/");n&&jt(n);return}_e("site-css",Pe);const t=await Ie();let a=null;Xt(e,t,a),a=await Fe(),a&&(At(a),Ut(a))}function Xt(e,t,a){if(I){if(e==="home"){de(I,Et(t,a));const n=document.getElementById("hero-canvas");n instanceof HTMLCanvasElement&&Lt(n),it(),mt()}else e==="whitepaper"&&(de(I,Pt(t)),document.title="CrazyCauldron — whitepaper",It());Ke(),He(I),Qt()}}function Ut(e){const t=document.getElementById("ticker-track");if(t)for(const a of Array.from(t.querySelectorAll("[data-live]"))){const n=a.dataset.live;n&&typeof e[n]=="number"&&(a.textContent=e[n].toLocaleString("en-US"))}}function Qt(){const e=window.location.hash.slice(1);e&&requestAnimationFrame(()=>{var t;return(t=document.getElementById(e))==null?void 0:t.scrollIntoView()})}Gt();
